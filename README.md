...
-   Guest/Logged users can see at home page movie details from carousel lists wich is getting from other api [The Movie Database (TMDB)](https://www.themoviedb.org/documentation/api)
