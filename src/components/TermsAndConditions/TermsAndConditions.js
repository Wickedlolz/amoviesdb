...
function TermsAndConditions({ show, onTermsClose }) {
    return (
        <Modal
            show={show}
            size="lg"
            ...
            centered
        >
            <Modal.Header onClick={onTermsClose} closeButton>
            ...
            <Modal.Body>
                ...
                <p>
                    Welcome to <b>EMoviesDB LLC</b> (“Company”, “we”, “our”,
                    “us”)!
                </p>
                <p>
                ...
                <p>
                    ...
                    emailing at <b>support@emoviesdb.com</b> so we can try to
                    find a solution. These Terms apply to all visitors, users
                ...
                <p>
                    ...
                    link or by emailing at support@emoviesdb.com.
                </p>
                ...
                <p>
                    EMoviesDB LLC has the right but not the obligation to
                    monitor and edit all Content provided by users.
                </p>
                <p>
                    In addition, Content found on or through this Service are
                    the property of EMoviesDB LLC or used with permission. You
                ...
                <p>
                    ...
                    the exclusive property of EMoviesDB LLC and its licensors.
                    ...
                    written consent of EMoviesDB LLC.
                </p>
                <p>
                ...
                <p>
                    ...
                    please submit your claim via email to support@emoviesdb.com,
                ...
                <p>
                    ...
                    support@emoviesdb.com.
                </p>
                <p>
                    12. <b>Error Reporting and Feedback</b>
                </p>
                <p>
                    You may provide us either directly at support@emoviesdb.com
                ...
                <p>
                    ...
                    services that are not owned or controlled by EMoviesDB LLC.
                </p>
                <p>
                    EMoviesDB LLC has no control over, and assumes no
                ...
                <p>
                    ...
                    <Link to="https://policymaker.io/">PolicyMaker.io</Link>, a
                ...
                <p>
                    ...
                    with the laws of Bulgaria, which governing law applies to
                ...
                <p>
                    ...
                    support by email: <b>support@emoviesdb.com</b>.
                </p>
                <p className={styles['end-of-terms']}>
                    These{' '}
                    <Link to="https://policymaker.io/terms-and-conditions/">
                        Terms of Service
                    </Link>{' '}
            ...
            <Modal.Footer>
                <Button onClick={onTermsClose}>Close</Button>
            </Modal.Footer>
        </Modal>
    );
}
